...
public class Dynetica extends Object {
    ...
    */
    public static void main (String args[]) {
         ...
         if (args.length > 0) {
              dynetica.util.DyneticaProperties.setProperty("workingDirectory", args[0]);
         }
         //Modified by Kanishk Asthana to handle Modular Systems
         new dynetica.gui.systems.ModularSystemManager(dynetica.util.DyneticaProperties.getProperty("workingDirectory")).show();
