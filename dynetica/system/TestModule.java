...
public class TestModule extends AbstractModule {
    ...
    public void initializeModule() {
        ...
        ProgressiveReaction reaction = new ProgressiveReaction(this.name
                + "Reaction1", this);
        reaction.setStoichiometry(this.name + "A" + "+" + this.name + "B"
                + "->" + this.name + "C");
        try {
            reaction.setKinetics(this.name + "k*[" + this.name + "A" + "]*["
                    + this.name + "B" + "]");
        } catch (Exception exp) {
