...
/**
 * AbstractSystem is anything that you can add somethings to it and get things
 * (using a String as the index) from it.
 * 
...
public interface AbstractSystem {
    ...
    /**
     * @deprecated use add(Entity e)
     */
    public void addEntity(Entity e);

    /**
     * @deprecated use get(Entity e)
     */
    ...
    /**
     * @deprecated use contains(String name)
     */
     ...
     * (It's assumed that the actual name of the Entity has already been
     * changed.)
     */
