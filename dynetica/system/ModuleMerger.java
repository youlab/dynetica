 ...
 */
 ...
 public static java.util.List findConflicts(ModularSystem superSystem,ModularSystem tempSystem){
    ...
    java.util.List progressiveReactions= tempSystem.getProgressiveReactions();
    java.util.List equilibratedReactions= tempSystem.getEquilibratedReactions();
    ...
    for(int i=0; i< parameters.size();i++){
      Entity en=(Entity) parameters.get(i);
        if(superSystem.contains(en.getName()) && !(en instanceof SimulationTimer))
            conflictedEntities.add(en);
    }
