...
public class Numerics  {
	...
	for (int i = 0; i < d.length; i++) {
	    ...
	    if (minPositive(d[i]) < tmp) tmp = dmin;
	}
	return tmp;
    }
    ...
    // Slightly different than MATLAB's logspace.  Instead of giving it powers of 10, 
    ...
    public static double[] logspace(double min, double max, int points) {
        ...
        d[points-1] = max; // in case there was some float error (which there probably was)
        return d;
    }
