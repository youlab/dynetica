...
public class TargetObjectiveEditor extends javax.swing.JPanel {
    ...
    public TargetObjectiveEditor(JFrame frame, ParameterSearchGeneticEditor p, TargetObjective to) {
        parentFrame = frame;
        psg = p;
        system = p.system;
        initComponents();
    ...
    private void initComponents() {
        ...
        objectiveChoice.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Function...", "Target Value", "Maximize", "Minimize" }));
        objectiveChoice.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                objectiveChoiceActionPerformed(evt);
            }
        });
        objectiveChoice.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(14, 14, 14)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(metricField)
                                    .addComponent(objectiveChoice, 0, 167, Short.MAX_VALUE)))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(32, 32, 32)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(objectiveChoice, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(13, 13, 13)
                .addComponent(objectiveTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void objectiveChoicePropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_objectiveChoicePropertyChange
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        TargetObjective to = new TargetObjective(metric.getSubstance(), objective, weight);
    ...
    private void objectiveChoiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_objectiveChoiceActionPerformed
        ...
        if (function.equalsIgnoreCase("Minimize")) {
            ...
            String targetInput = JOptionPane.showInputDialog(this, "Target value?");
