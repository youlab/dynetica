...
/**
 * The JPanel based GUI for setting up sequential parameter scan
 * @author lingchong
 */
public class SequentialTwoParameterScanEditor extends javax.swing.JPanel {
    ...
    dynetica.algorithm.SequentialTwoParameterScan mps = null;
    dynetica.system.ReactiveSystem system = null;
    
    
    /** Creates new form BasicSensitivityAnalysisEditor */
    public SequentialTwoParameterScanEditor(SequentialTwoParameterScan mps) {
        this.mps = mps;
    ...
    private void initComponents() {
        ...
        selectionBox.setToolTipText("Select a parameter or substance as an independent variable. Its value will be varied between the specified minimum and maixmum values. When ready, click \"Add Variable\" button to add to the list.");
        ...
        cyclesField.setText("10");
        cyclesField.setToolTipText("The number of different values for the selected variable, between the specified minimum and maximum values.");
        ...
        metricJList.setToolTipText("The list of metrics to be evaluated against the chosen independent variables.");
        ...
        variableList.setToolTipText("The list of independent variables (Parameters or Substances). For a parameter, its value will be varied. For a substance, its initial value will the varied, but its value will change according to the system dynamics.");
...
//      sa.setMin(Double.parseDouble(minField.getText()));
    ...
    private void plotButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_plotButtonActionPerformed
     new dynetica.gui.plotting.SequentialTwoParameterScanWindow(mps).show();
...
//      sa.setLogScale(logScaleBox.isSelected());
    ...
    private void addVariableButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addVariableButtonActionPerformed
        ...
        if (!variables.contains(currentVariable)) {
            String varDisplay = currentVariable.getName() + 
        ...
        if (variables.size() == 1) {
            mps.setVariable1(currentVariable);
            mps.setNumPoints1(Integer.parseInt(cyclesField.getText()));
        }
        
        else {
            mps.setVariable2(currentVariable);
            mps.setNumPoints2(Integer.parseInt(cyclesField.getText()));
        }
