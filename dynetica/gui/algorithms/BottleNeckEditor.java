...
public class BottleNeckEditor extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 24, -1, -1));

        jLabel2.setText("Cheater Species");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 55, -1, -1));

        jLabel3.setText("Population Size");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 86, -1, -1));

        cooperatorChoiceBox.setModel(cooperatorChoiceList);
        add(cooperatorChoiceBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 20, 141, -1));

        cheaterChoiceBox.setModel(cheaterChoiceList);
        add(cheaterChoiceBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 50, 141, -1));

        populationField.setText("5");
        add(populationField, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 80, 67, -1));
        ...
        add(runButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, -1, -1));
        ...
        add(pauseButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(136, 260, -1, -1));
        ...
        add(plotButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(246, 260, -1, -1));
        ...
        add(fractionField, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 110, 141, -1));

        jLabel5.setText("Simulation Time");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 142, -1, -1));

        timeField.setText("100");
        add(timeField, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 140, 141, -1));

        fixedMeanChoice.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Fixed", "Mean" }));
        add(fixedMeanChoice, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 80, 64, -1));

        jLabel6.setText("Number of Bottleneck Rounds");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 168, -1, -1));

        roundsField.setText("5");
        add(roundsField, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 170, 141, -1));
        ...
        add(saveCheckBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 192, -1, -1));
        ...
        add(normalizeCheckBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 219, -1, -1));
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, normalizeCheckBox, org.jdesktop.beansbinding.ELProperty.create("${selected}"), initialValField, org.jdesktop.beansbinding.BeanProperty.create("editable"));
        bindingGroup.addBinding(binding);

        add(initialValField, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 220, 100, -1));

        bindingGroup.bind();
    }// </editor-fold>//GEN-END:initComponents

    private void runButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_runButtonActionPerformed
        Substance cheater = system.getSubstance((String) cheaterChoiceBox.getSelectedItem());
        Substance cooperator = system.getSubstance((String) cooperatorChoiceBox.getSelectedItem());
        ...
        bns = new BottleNeckSimulation(system, cooperator, cheater, subpopSize, initFrac, simTime, rounds);
        if (((String) fixedMeanChoice.getSelectedItem()).equalsIgnoreCase("Mean")) {
            bns.setPoisson(true);
        }
