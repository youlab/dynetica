...
/**
 * A lightweight editor for Stochastic class (which implements Gillespie's algorithm).
 * @author Lingchong You
 * @version 0.01
 */
public class FirstReactionMethodEditor extends javax.swing.JPanel {
    
    dynetica.algorithm.FirstReactionMethod algorithm;
    public FirstReactionMethodEditor(dynetica.algorithm.FirstReactionMethod s) {
        this.algorithm = s;
        initComponents ();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gillespie's Algorithm");
        ...
        simulationNumberField.setHorizontalAlignment(javax.swing.JTextField.TRAILING);
        simulationNumberField.setText(String.valueOf(algorithm.getNumberOfRounds()));
        simulationNumberField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                simulationNumberFieldActionPerformed(evt);
            }
        });
        simulationNumberField.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
    ...
    private void simulationNumberFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_simulationNumberFieldFocusLost
       algorithm.setNumberOfRounds(Integer.parseInt(simulationNumberField.getText()));
...
/*        
    ...
    private void simulationNumberFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simulationNumberFieldActionPerformed
        algorithm.setNumberOfRounds(Integer.parseInt(simulationNumberField.getText()));
