...
/**
 * A lightweight editor for DirectMethod class (which implements Gillespie's algorithm).
 * @author Lingchong You
 * @version 0.01
 */
public class OptimizedDirectMethodEditor extends javax.swing.JPanel {

    /** Creates new customizer RK4Editor */
    dynetica.algorithm.OptimizedDirectMethod algorithm;
    public OptimizedDirectMethodEditor(dynetica.algorithm.OptimizedDirectMethod s) {
        this.algorithm = s;
        initComponents ();
    }
