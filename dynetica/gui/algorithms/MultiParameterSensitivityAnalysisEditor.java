...
public class MultiParameterSensitivityAnalysisEditor extends javax.swing.JPanel {
    ...
    public MultiParameterSensitivityAnalysisEditor(MultiParameterSensitivityAnalysis mps) {
        this.mps = mps;
...
//      sa.setMin(Double.parseDouble(minField.getText()));
    ...
    private void plotButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_plotButtonActionPerformed
      new dynetica.gui.plotting.MultiParameterSensitivityPlaneWindow(mps).show();
