...
private GeneExpressionMachinery gem;
    ...
    private void initComponents() {
        ...
        nameLabel.setText("<html> <i>" + gem.getShortClassName()+ " </i> " + gem.getName());
        ...
        elongationLabel.setToolTipText("The elongation rate of the ribosome (in AA residues per second)");
        ...
        spacingLabel.setToolTipText("The minimum spacing that's required between neighboring ribsomes\nalong the mRNA being translated.");
