...
public class GenomeTranslocationEditor extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        genomLabel.setToolTipText("The (usually viral) genome that ungos translocation.");
        ...
        jLabel1.setText("<html> <i> GenomeTranslocation </i> " + reaction.getName());
...
/*  private void setName() {
      String oldName = reaction.getName();
      String newName = nameField.getText().trim();
      if (newName.length() > 0 && oldName.compareTo(newName) != 0) {
          reaction.setName(newName);
          //
          // fire a propertyChange Event so that the parent panel of this panel can
          // respond accordingly.
          //
