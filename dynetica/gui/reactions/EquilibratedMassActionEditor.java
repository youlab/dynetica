...
public class EquilibratedMassActionEditor extends javax.swing.JPanel {
    ...
    public EquilibratedMassActionEditor(dynetica.reaction.EquilibratedMassAction reaction) {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("<html> <i> Equilibrated Reaction </i> " + getReactionName());
  ...
  private void setStoichiometry() {
      ...
      if (stoichiometry.length() > 0 && stoichiometry.compareTo(oldStoichiometry) !=0 ) {
  ...
  public static class Tester {
      public static void main(String [] args) { 
          dynetica.reaction.EquilibratedMassAction reaction =
            new dynetica.reaction.EquilibratedMassAction("TestReaction",
                new dynetica.system.ReactiveSystem("Test"));
          try {
              reaction.setProperty("stoichiometry", "A + B + C + D -> E + F + K + L");
              reaction.setProperty("K", "k1 * [A] * sin([B]) * log([C]) / ([E]^[F] * [F]^100 * [K] * [L])");
