...
public class Histogram {
    ...
    public void setData(double[] dataPoints, int numBins, String label) {
        ...
        double binWidth = (finalbin[1].doubleValue() - firstbin[0]
                .doubleValue()) / numBins;
        ...
        title += "; mean = "
                + dynetica.util.Numerics.displayFormattedValue(mean);
        ...
        // Format y axis
        barPlot.getAxis(BarPlot.AXIS_Y).setRange(
                0.0,
                MathUtils.ceil(
                        histogram.getStatistics().get(Statistics.MAX) * 1.1,
                        25.0));
        barPlot.getAxisRenderer(BarPlot.AXIS_Y).setSetting(
                AxisRenderer.TICKS_ALIGNMENT, 0.0);
        barPlot.getAxisRenderer(BarPlot.AXIS_Y).setSetting(
                AxisRenderer.TICKS_MINOR, false);
        barPlot.getAxisRenderer(BarPlot.AXIS_Y).setSetting(
                AxisRenderer.INTERSECTION, 0.0);
