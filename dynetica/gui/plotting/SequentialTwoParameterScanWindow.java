...
public class SequentialTwoParameterScanWindow extends javax.swing.JFrame {
    ...
    public final void updateFigure() {
        ...
        // int numPoints1 = algorithm.getNumPoints1(); // number of points for
        // each trace
        ...
        if (firstIndex == 0) {
            ...
            yValues = dynetica.util.Numerics
                    .transpose(algorithm.getYValues()[yIndex]);
        }
        ...
        for (int i = 0; i < x2Values.length; i++) {
            yLabels[i] = "M" + String.valueOf(yIndex + 1) + ":" + secondLabel
                    + "="
                    + dynetica.util.Numerics.displayFormattedValue(x2Values[i]);
    ...
    private void matlabPlotMenuItemActionPerformed(
        ...
        try {
            InteractiveFigure.matlabPlot(firstLabel, yLabels, x1Values,
                    yValues, logXItem.isSelected(), logYItem.isSelected());
        }
