...
public class MNode extends EntityNode{
   ...
   public double getWidth() {
    ...
    public void draw(Graphics2D g) {
        ...
        if (textVisible) 
            g.drawString(getNodeName(), (float) (getX() + getWidth()), (float) getY());//this is pretty cool dude, 
        //a very large proportion of the code can be reused! Awesome, this is very interesting!
