...
public class EquationsMatlabStochastic extends javax.swing.JPanel {
    ...
    private String getEquations() {
        ...
        equationText.append("numReactions = " + reactionsList.length + ";" + newline + newline);
        ...
        for (int i=0; i < reactionsList.length; i++) {
            ...
            if (i == (reactionsList.length - 1)) {
                equationText.append("]; % " + r.getName() + ": " + ann + newline + newline);
            }
            else {
        ...
        equations = annText.toString() + generateFunctionAppendix() + equationText.toString();
        return equations;
    }
