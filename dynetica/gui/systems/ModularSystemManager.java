...
public class ModularSystemManager extends javax.swing.JFrame {
    ...
    private void buildAlgorithmBoxModel() {
        String[] algorithmNames = { "RungeKutta4",  
                        "RungeKuttaFehlberg", 
                        "DirectMethod",
    ...
    // you have to get the summer internship before you leave from this place for new york
    ...
    private void sdeItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sdeItemActionPerformed
     //
      ...
      //
      if (currentAlgorithm == null || ! (currentAlgorithm instanceof OptimizedDirectMethod)) {
          currentAlgorithm = new OptimizedDirectMethod();
          currentAlgorithm.setSystem(currentSystem);
      }
      
      javax.swing.JFrame algoFrame = new JFrame("Stochastic Differential Equation");
    ...
    private void optimizedDirectItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optimizedDirectItemActionPerformed
      //
      // Only create a new instance of the algorithm if necessary.
      //
      if (currentAlgorithm == null || ! (currentAlgorithm instanceof OptimizedDirectMethod)) {
    ...
    private void firstReactionMethodItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_firstReactionMethodItemActionPerformed
      //
      // Only create a new instance of the algorithm if necessary.
      //
      if (currentAlgorithm == null || ! (currentAlgorithm instanceof FirstReactionMethod)) {
    ...
    private void directMethodItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_directMethodItemActionPerformed
      ...
      // Only create a new instance of the algorithm if necessary.
      //
      if (currentAlgorithm == null || ! (currentAlgorithm instanceof DirectMethod)) {
    ...
    private void vRungeKutta4ItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_vRungeKutta4ItemActionPerformed
      ...
      // Only create a new instance of the algorithm if necessary.
      //
      if (currentAlgorithm == null || !(currentAlgorithm instanceof RungeKuttaFehlberg)) {
          currentAlgorithm = new RungeKuttaFehlberg();
          currentAlgorithm.setSystem(currentSystem);
      }
      
      javax.swing.JFrame algoFrame = new JFrame("Variable Time-step 4th Order Runge-Kutta Algorithm");
      javax.swing.JPanel algorithmEditor = currentAlgorithm.editor();
      algoFrame.getContentPane().add(algorithmEditor);
      algoFrame.pack();
      algoFrame.setLocation(400, 300);
    ...
    private void rungeKutta4ItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rungeKutta4ItemActionPerformed
      ...
      // Only create a new instance of the algorithm if necessary.
      //
      if (currentAlgorithm == null || !(currentAlgorithm instanceof RungeKutta4)) {
          currentAlgorithm = new RungeKutta4();
          currentAlgorithm.setSystem(currentSystem);
      }
      
      javax.swing.JFrame algoFrame = new JFrame("Fixed Time-step 4th Order Runge-Kutta Algorithm");
      javax.swing.JPanel algorithmEditor = currentAlgorithm.editor();
      algoFrame.getContentPane().add(algorithmEditor);
      algoFrame.pack();
      algoFrame.setLocation(400, 300);
    ...
    private void showSimToolBarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showSimToolBarItemActionPerformed
      setToolBar();
    }//GEN-LAST:event_showSimToolBarItemActionPerformed

    private void showFileToolBarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showFileToolBarItemActionPerformed
      setToolBar();
    ...
    private void psaItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_psaItemActionPerformed
     ...
     frame.getContentPane().add(new SensitivityAnalysisEditor( 
                                new SensitivityAnalysis(currentSystem)));
     frame.pack();
     frame.show();
  ...
  private void algorithmBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_algorithmBoxActionPerformed
      ...
      String newAlgorithmName = "dynetica.algorithm." + algorithmBoxModel.getElementAt(index);
      
      //
      // Only create a new instance of the algorithm if necessary.
      //
      if (currentAlgorithm == null || currentAlgorithm.getClass().getName().compareTo(newAlgorithmName) != 0) {
           try {
                currentAlgorithm = (Algorithm) Class.forName(newAlgorithmName).newInstance();
           }
           catch (Exception e) {
          }
          currentAlgorithm.setSystem(currentSystem);
      ...
      javax.swing.JFrame algoFrame = new JFrame("Algorithm " + newAlgorithmName);
      javax.swing.JPanel algorithmEditor = currentAlgorithm.editor();
      algoFrame.getContentPane().add(algorithmEditor);
      algoFrame.pack();
      algoFrame.setLocation(400, 300);
  ...
  private void systemPaneStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_systemPaneStateChanged
    ...
    private void psMultiSubstanceItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_psMultiSubstanceItemActionPerformed
        viewPSMS();
    ...
    private void editMathActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editMathActionPerformed
        ApplicationFrame frame = new ApplicationFrame("Define/Modify Customized Math Expressions");
    ...
    private void viewMatlabStochasticActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewMatlabStochasticActionPerformed
        viewMatlabStochastic();
    }//GEN-LAST:event_viewMatlabStochasticActionPerformed

    private void psDoseResponseItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_psDoseResponseItemActionPerformed
        viewPSDR();
    ...
    ApplicationFrame frame = new ApplicationFrame("MultiParameter Sensitivity Analysis");
     frame.getContentPane().add(new MultiParameterSensitivityAnalysisEditor( 
    ...
    ApplicationFrame frame = new ApplicationFrame("Basic Sensitivity Analysis");
        frame.getContentPane().add(new dynetica.gui.algorithms.BasicSensitivityAnalysisEditor(
    ...
    private void rssItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rssItemActionPerformed
        ApplicationFrame frame = new ApplicationFrame("Repeated stochastic simulations");
        frame.getContentPane().add(new dynetica.gui.algorithms.RepeatedStochasticSimulationsEditor(
    ...
    private void bssaMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bssaMenuItemActionPerformed
      ApplicationFrame frame = new ApplicationFrame("Basic stochastic sensitivity analysis");
        frame.getContentPane().add(new dynetica.gui.algorithms.BasicStochasticSensitivityEditor(
    ...
    private void twoParaScanItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_twoParaScanItemActionPerformed
       ApplicationFrame frame = new ApplicationFrame("Sequential two-parameter scan");
        frame.getContentPane().add(new dynetica.gui.algorithms.SequentialTwoParameterScanEditor(
    ...
    private void viewPSMC() {
        JFrame jf = new JFrame("Parameter Search for " + currentSystem.getName());
        jf.getContentPane().add(new ParameterSearchMonteCarloEditor(currentSystem));
        jf.pack();
        jf.show();
    }
    
    private void viewPSMS() {
        JFrame jf = new JFrame("Multi Substance Parameter Search for " + currentSystem.getName());
        jf.getContentPane().add(new ParameterSearchMultiSubstanceEditor(currentSystem));
        jf.pack();
        jf.show();
    }
    
    private void viewNOCT() {
        JFrame jf = new JFrame("Noise Optimization for " + currentSystem.getName());
    ...
    private void viewBottleneck() {
        JFrame jf = new JFrame("Bottleneck Simulation for " + currentSystem.getName());
    ...
    private void viewParameterSearchGenetic() {
        JFrame jf = new JFrame("Genetic Parameter Search for " + currentSystem.getName());
        jf.getContentPane().add(new ParameterSearchGeneticEditor(currentSystem));
        jf.pack();
        jf.show();
    }
    
    private void viewMatlabStochastic() {
        JFrame jf = new JFrame("MATLAB Stochastic Algorithm for " + currentSystem.getName());
    ...
    private void viewPSDR() {
        JFrame jf = new JFrame("Dose Response Parameter Search for " + currentSystem.getName());
        jf.getContentPane().add(new ParameterSearchDoseResponseEditor(currentSystem));
        jf.pack();
        jf.show();
    }
...
private void merge(){
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
          try {
            ...
            JOptionPane.showMessageDialog(this, "Merge Unsuccessful!", "Error", JOptionPane.ERROR_MESSAGE);
          }
        }
...
private void addModule(){
    ...
    JFileChooser fileChooser = new JFileChooser(workDir);
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
          try {
            ...
            JOptionPane.showMessageDialog(this, "Import Unsuccessful!", "Error", JOptionPane.ERROR_MESSAGE); 
          }
        }
    ...
    private void newModularSystem(){
         String newName;
        for (;;) {
           newName = JOptionPane.showInputDialog("Enter the name for the new system:").trim();
           if (newName.length() > 0) {
                break;
            }
        }
    ...
    private void renameSystem() {
         String newName = (String) JOptionPane.showInputDialog(this, "New name", "Input", 
          JOptionPane.QUESTION_MESSAGE, null, null, currentSystem.getName());
         if (newName.length() > 0 && newName.compareTo(currentSystem.getName()) != 0) {
    ...
    private void plotCurrentSimulationResult() {
        ...
        //
        // July 18, 2013. This code is revised to use a new plot window to show rates as well.
        //
    ...
    private void showAnnotation(){
      ...
      javax.swing.JPanel annotationEditor = currentSystem.systemInformation.editor();
    ...
    private void closeSystem() {
        if (openedSystems.size() > 1) {
            ...
            systemPane.remove(0);            
            //
            // disable all the buttons that are meaningful only when some systems are opened
            //
            simMenu.setEnabled(false);
            editMenu.setEnabled(false);
            renameButton.setEnabled(false);
    ...
    private void openSystem() {
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
          try {
              ...
              workDir = file.getParentFile().getAbsolutePath();
              dynetica.util.DyneticaProperties.setProperty("workingDirectory", workDir);
              currentSystem = ((ReactiveSystem) ModularSystemBuilder.build(file));
              addSystem();
              showAnnotation();
              System.out.println("System initialization OK.");
          }
          catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error in system file!", "Error", JOptionPane.ERROR_MESSAGE); 
          }
        }
