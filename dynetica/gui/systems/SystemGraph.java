 ...
 */
public class SystemGraph extends javax.swing.JPanel 
...
/*        File systemFile = system.getFile();
        if (systemFile != null) {
            File graphFile = new File(systemFile.getPath() + ".graph");
            if (graphFile.exists())
                readGraph(graphFile);
                reset();
        }*/
    ...
    protected void reset() {
       if (substanceNodes != null)
        ...
        for (int i = 0; i < substanceNumber; i ++) {
            ...
            //only keep substances that aren't ExpressionVariables in the substanceNodeMap
            else
  ...
  private void hideNameBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hideNameBoxActionPerformed
    ...
    private void zoomOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zoomOutActionPerformed
        ...
        setPreferredSize(new Dimension((int) (getWidth() * .85), (int) (getHeight() * .85)));
        repaint();
        fireSizeChange();
 ...
 public void changeNodeSize(double ratio) {
    ...
    public class GraphMouseListener implements MouseListener {
            ...
            public void mousePressed(java.awt.event.MouseEvent e) {
                ...
                // if the currentNode is null, the the mouse is pressed at a position not touching any node.
