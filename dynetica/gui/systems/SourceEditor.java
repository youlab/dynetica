 ...
 * @version 1.0
 * has yet to implement undo function.
 */
public class SourceEditor extends javax.swing.JPanel {
 ...
 //       undoButton.add(undoAction); 
    ...
    private void initComponents() {
        ...
        saveButton.setToolTipText("Update the system and save to the input file.");
        ...
        updateButton.setToolTipText("Update the system without saving the file.");
        ...
        lockBotton.setToolTipText("For advanced users only. Unlock to edit the input file directly.");
