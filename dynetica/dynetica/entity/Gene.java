...
public class Gene extends GeneticElement {
    ...
    /**
     * Holds value of property kTranscription. Note kTranscription is defined as
     * an expression rather than a parameter so that it will be more flexible:
     * it can accept a single parameter or combinations of variables rather than
     * a single parameter. The same is true for kTranslation. Both
     * kTranscription and kTranslation can be initialized using the Expression
     * parser defined in the expression package (this parser, well, is indeed
     * very important!!!). In a sense, this approach is probably inspired by
     * Mathematica, where everything is an expression.
     */
    ...
    public void setProducts() {
        ...
        //
        // set up the protein product for the gene only if it's going to be
        // translated.
        //
        if (geneType == mRNA_GENE) {
            if (getGeneticSystem().contains(getProteinName())) {
                try {
                    protein = (Protein) (getGeneticSystem()
                            .get(getProteinName()));
                } catch (Exception e) {
    ...
    public GeneralExpression getKTranscription() {
        ...
        //
        // if kTranscription is not set, use the length of the gene as the
        // weighting factor
        //
     ...
     * 
     * @param kTranscription
     *            New value of property kTranscription.
     */
    ...
    public void setKTranscription(String expression)
        ...
        try {
            setKTranscription(ExpressionParser.parse(this.getGeneticSystem(),
                    expression));
     ...
     * 
     * @param kTranslation
     *            New value of property kTranslation.
     */
    ...
    public void setKTranslation(String expression)
            throws IllegalExpressionException {
        try {
            setKTranslation(ExpressionParser.parse(this.getGeneticSystem(),
                    expression));
        } catch (IllegalExpressionException iee) {
            throw iee;
        }
    ...
    public void setProperty(String propertyName, String propertyValue)
        ...
        //
            ...
            throw new UnknownPropertyException("UnknownProperty for Gene "
                    + propertyName);
     ...
     * 
     * @param transcription
     *            New value of property transcription.
     */
     ...
     * 
     * @param translation
     *            New value of property translation.
     */
