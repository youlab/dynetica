...
//        value = initialValue;
        ...
        //added by LY (6/2016) to enable clear the "memory" of calculation by some math expressions.
        if (rateExpression != null) rateExpression.reset();
        if (stochasticTerm != null) stochasticTerm.reset();
    }
