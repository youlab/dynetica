...
public class DMath {
    ...
    // and(a,b), or(a,b), eq(a,b), neq(a,b) added by LY 6/2016
    public static GeneralExpression and(GeneralExpression a, GeneralExpression b) {
            return new And(a, b);
    }
    
    public static GeneralExpression or(GeneralExpression a, GeneralExpression b) {
            return new Or(a, b);
    }
    
    public static GeneralExpression eq(GeneralExpression a, GeneralExpression b) {
            return new EQ(a, b);
    }
    
    public static GeneralExpression neq(GeneralExpression a, GeneralExpression b) {
            return new NEQ(a, b);
    }
    
    public static GeneralExpression gt(GeneralExpression a, GeneralExpression b) {
            return new GT(a, b);
    }

    public static GeneralExpression gte(GeneralExpression a, GeneralExpression b) {
            return new GTE(a, b);
    }
    
    public static GeneralExpression lt(GeneralExpression a, GeneralExpression b) {
            return new LT(a, b);
    }
   
    public static GeneralExpression lte(GeneralExpression a, GeneralExpression b) {
            return new LTE(a, b);
    }
    ...
    // added by LY 6/2016
    public static GeneralExpression and(List operandList){
        Object[] operands = operandList.toArray();
        GeneralExpression a = (GeneralExpression) operands[0];
        GeneralExpression b = (GeneralExpression) operands[1];
        return and(a,b);
