...
public class ExpressionParser {
    ...
    public static GeneralExpression parse(AbstractSystem system, String inputStr)
        ...
        while (i < inputStr.length()) {
            ...
            else if (Character.isLetter(c) && !(ExpressionConstants.isCompareOp(c))
                    && !(isIfOp(inputStr, i))) {
                int j = i;
                while (i < inputStr.length()
...
//                System.out.println(name);
 ...
 /* currently logical operations are not yet implemented separately.       
                        else if (opType == 6) {
                            doLogic(op);
                            operatorStack.pop();
                        } 
...
//LY (6/2013): currently logic operations are treated as binary or multiple operations.
                            doBinary(ope);
                            operatorStack.pop();
                        } 
