...
public class TranscriptionRegulationElement extends GeneticElement {
     ...
     * 
     * @param v
     *            Value to assign to RNAP.
     */
    public void setRNAP(RNAPolymerase v) {
        this.RNAP = v;
    }
    ...
    public javax.swing.JPanel editor() {
        return new dynetica.gui.genetics.TranscriptionRegulationElementEditor(
                this);
    }
    ...
    public String getCompleteInfo() {
        StringBuffer tmp = new StringBuffer(getFullName() + "{" + NEWLINE
                ...
                + getEnd() + "}" + NEWLINE + "\tefficiency {" + getEfficiency()
                + "}" + NEWLINE);
        if (getRNAP() != null)
