...
public class GeneExpressionMachinery extends Protein {
    ...
    /**
     * Spacing is the minimal distance (in NTPs) between
     * neighboring RNAP along a DNA.
 */
 ...
 * @param elongationRate New value of property elongationRate.
 */
public void setElongationRate(GeneralExpression elongationRate) {
    this.elongationRate = elongationRate;
}

public void setElongationRate(String expression) throws IllegalExpressionException {
    try {
