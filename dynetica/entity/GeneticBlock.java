...
public class GeneticBlock extends GeneticElement {
    ...
    public String toString() {
        return (getName() + " " + getWtPosition() + " " + getStart() + " "
                + getEnd() + " " + numberOfElements());
    }
    ...
    public static class Tester {
        public static void main(String[] args) {
            ...
            System.out.println("Block: " + gb1 + " is generated from "
                    + NEWLINE + "GeneticElement: " + ge1);

            if (gb1.overlaps(ge2)) {
                gb1.append(ge2);
                System.out.println(gb1.numberOfElements());
                System.out.println("Block: " + gb1 + " is combined by \n"
                        + "GeneticElements: " + gb1.element(0) + " and "
                        + gb1.element(1) + "\n");
            }
