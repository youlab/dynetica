...
public class Annotation extends Entity{
    ...
    @Override//Modified by Kanishk Asthana 28 June 2013
   public void setProperty(String propertyName,String propertyValue) throws UnknownPropertyException, InvalidPropertyValueException {
        ...
        { 
          if (propertyName.compareToIgnoreCase("X") == 0) {
            ((dynetica.system.AbstractModule) this.getSystem()).setX(Double.parseDouble(propertyValue));
          }
          else if (propertyName.compareToIgnoreCase("Y") == 0) {
            ((dynetica.system.AbstractModule) this.getSystem()).setY(Double.parseDouble(propertyValue));
          }
        }
        else
            throw 
...
//Modified by Kanishk Asthana 28 June 2013
    public String getCompleteInfo() {
        ...
        if(this.getSystem() instanceof dynetica.system.AbstractModule){
            dynetica.system.AbstractModule system=(dynetica.system.AbstractModule) this.getSystem();
            sb.append(" X  {" + system.getX()+"}" + NEWLINE+
            " Y  {" + system.getY()+"}" + NEWLINE);
        }
