...
//    protected static int entityIndex = 0;
     ...
     * @param the supersystem of the entity
     *    Note: when an Entity is constructed this way, the system automatically
     *    registers it into its HashMap.
     */
 ...
 */
     ...
     * @param annotation New value of property annotation.
 */
    public void setAnnotation(String annotation) {
        // Note by Lingchong You. August 6, 2002.
        // the replacement is a hack so that the annotation is on a single line, such that the 
        // system builder can properly read it. need to modify the system builder.
        //
 ...
 */
    public void setName(String name) {
        ...
        this.name = name;
        if (hasSystem()) getSystem().rename(oldName, name);
    }
 ...
 */
     ...
     * @param toPrint New value of property toPrint.
 */
