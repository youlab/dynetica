...
public class Parameter extends EntityVariable {
    ...
    /**
     * the field <code> reactions </code> stores a list of reactions that the
     * Substance is involved in
     */
    ...
    // object
    // is being initialized. How can I check whether a parameter is used in a
    // certain
    // reaction?
    //
    ...
    /*
     * remove the specified reaction from the list of reactions that this
     * parameter is involved in. This method should be used when the specified
     * reaction is removed from a system.
     */
    ...
    public Parameter(String name, AbstractSystem system, double defaultValue,
     ...
     * 
     * @param defaultValue
     *            New value of property defaultValue.
     */
    ...
    public String getCompleteInfo() {
        return (getFullName() + " {" + NEWLINE + " Value { " + getValue() + "}"
                + NEWLINE + " Min {" + getMin() + "}" + NEWLINE + " Max {"
                + getMax() + "}" + NEWLINE + " Annotation { " + getAnnotation()
                + "}" + NEWLINE + "}" + NEWLINE);
    }
    ...
    public void setProperty(String propertyName, String propertyValue)
        ...
        //
            ...
            throw new UnknownPropertyException(
                    "Unknown property for Parameter " + propertyName + " "
                            + propertyValue);
    }
