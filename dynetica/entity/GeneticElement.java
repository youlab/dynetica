...
public class GeneticElement extends LinearSubstance {
    ...
    public GeneticElement() {this("GeneticElement" + geneticElementIndex ++, null, 0, 0);}
    ...
    public void setStart(int newStart) {
        if (getStart() != newStart) {
            ...
            if (getGenome() != null) getGenome().adjustElementPosition(this);
        }
    }
    
    public void shift(int distance) {
        /**
         * move the element leftward (when distance < 0)
         * or rightward (when distance>0) by |distance| units.
         */
    ...
    /**
     * overrides the setRateExpression() method defined in Substance
     * Currently, it's assumed that the level of the GeneticElements 
     * won't change as the function of time. Thus the rate expression
     * is set to be zero.
     **/
 ...
 */
    ...
    public static class Tester {
	    ...
	    Genome s = new Genome();
            GeneticElement elm1 = new GeneticElement("Genetic_Element",s, 10, 30);
            System.out.println(elm1);
            GeneticElement elm2 = new GeneticElement("Genetic_Element2",s, 10, 20);
