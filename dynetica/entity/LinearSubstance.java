...
public class LinearSubstance extends Substance 
    implements Range {
...
//	this("LinearSubstance" + entityIndex++);
	...
	return((len1+len2) > (range.getEnd() - getStart() +1)
		 && (len1+len2) > (getEnd() - range.getStart() + 1) );
    }
    ...
    public boolean isInsideCell() {return insideCell;}
    public void setInsideCell(boolean inside) {this.insideCell = inside;}    
     ...
     * @param realStart New value of property realStart.
     */
     ...
     * @param realEnd New value of property realEnd.
     */
     ...
     * @param numTotalUnits New value of property numTotalUnits.
     */
