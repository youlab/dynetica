...
public class RNAPolymerase extends GeneExpressionMachinery {
  ...
  /*  public RNAPolymerase(String name, GeneticSystem system, int start, int end) {
    ...
    public GeneralExpression getTotalTranscriptionActivity() {
        ...
        for (int i = 0; i < genes.size(); i++) {
            ge = DMath.sum(ge, DMath.multiply( ((Gene) genes.get(i)).getKTranscription() , ((Gene) genes.get(i))));
        }
