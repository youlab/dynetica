 ...
 * 
 * This class implements Gillespie's First Reaction Method in stochastic
 * simulations The results of this method is equivalent to the Direct Method.
 * 
 * @author Lingchong You
 * 
 *         Note: July 2013, Lingchong You The code is modified to allow storage
 *         of rates at different sampling time points. The rates are in fact
...
public class FirstReactionMethod extends Algorithm {
    ...
    public FirstReactionMethod(ReactiveSystem system, double samplingStep,
