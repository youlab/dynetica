...
public class ParameterSearchDoseResponse implements Runnable {
    ...
    Variable variable;
    double[] xValues; // The dose (if dose response) or parameter (if
    ...
    public ParameterSearchDoseResponse(ReactiveSystem s, Parameter[] p,
            ArrayList<TargetDoseObjective> tdo, Variable v, double[] xvals,
        ...
        for (int generation = 0; generation <= numGenerations; generation++) {
            ...
            if (generation == numGenerations) {
                String message = "Maximum generations reached.\nBest results shown below.\n"
                        ...
                        + "Click Run again to continue this search.";
        ...
        for (ParameterVector pv : population) {
            ...
            for (int i = 0; i < xValues.length; i++) {
                ...
                for (int j = 0; j < objectives.size(); j++) {
                    metricValues[j][i] = objectives.get(j).getMetric()
                            .getValue();
                }
            }
    ...
    public ArrayList<TargetDoseObjective> getObjectives() {
        return objectives;
    }
