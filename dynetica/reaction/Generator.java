...
public class Generator extends ProgressiveReaction {
    ...
    public Generator(String name,ReactiveSystem system,Substance p,GeneralExpression generationRate) {
        super(name, system);
        setProduct(p);
 ...
 */
    ...
    public String toString() {
        ...
        " Product { " + getProduct().getName() + "}" + NEWLINE +
        " Kinetics { " + getKinetics().toString() + "}" + NEWLINE +
