...
public class MichaelisMentenReaction extends ProgressiveReaction {
    ...
    public MichaelisMentenReaction(String name, ReactiveSystem system,
            GeneralExpression vmax, GeneralExpression km) {
        super(name, system);
        this.vmax = vmax;
        this.km = km;
    }
     ...
     */
    public GeneralExpression getVmax() {
        return vmax;
    }
     ...
     * @return Value of km.
     */
    public GeneralExpression getKm() {
        return km;
    }
    ...
    //
    // the following method updates the rate expression after a change is made
    // to
    ...
    private void updateRateExpression() {
        if (substrate != null && enzyme != null && product != null
            ...
            //
            GeneralExpression e = DMath.divide(
                    DMath.multiply(DMath.multiply(vmax, enzyme), substrate),
    ...
    public String toString() {
        ...
        tmp.append("  X {" + getX() + "}" + NEWLINE + "  Y  {" + getY() + "}"
                + NEWLINE);
