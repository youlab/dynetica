...
/**
 * Decay reaction describes the following simple reaction:
 * stoichiometry: A -> 
 * kinetics: k [A]
...
public class Decay extends ProgressiveReaction {   
    ...
    public Decay(String name, ReactiveSystem system, Substance s, GeneralExpression k) {
        super(name, system);
        setSubstrate(s);
        setK(k);
    }
 ...
 */
     ...
     * @param substrate New value of property substrate.
 */
 ...
 */
    ...
    public String toString() {
        ...
        "  Substrate { " + getSubstrate().getName() + "}" + NEWLINE +
        " k {" + getK().toString() + "}" + NEWLINE +
    ...
    public void setProperty(String propertyName, String propertyValue)
     ...
     public Object clone(){
         Decay d = new Decay(this.name+"_clone",
