 ...
 * @version 1.0
 * 
 * This class generates a random number following the Normal (Gaussian) distribution, with a mean of 0 and standard
 * deviation of 1.0.
  */
...
public class Normal extends NonExpression {
    ...
    /** every time this is executed, the class will generate the same number unless it has been reset
     */
    public void compute() {
