...
public class ExpressionParser{
    ...
    private static ExpressionConstants exprBuilder = ExpressionConstants.getInstance();
    private static ExpBuilder expBu = ExpBuilder.getInstance();

    
    // Rewrite by Apirak Hoonlor, 07/05/01. To fix min, max and scientific notation.
...
// Postconditions: None
    ...
    private static void processOp(String theOp)throws IllegalExpressionException {
	String before;
	if(! operatorStack.empty()) {
