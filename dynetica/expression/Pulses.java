 ...
 * @version 1.0 Generates a continuous sequence of square pulses. Usage:
 *          pulses(T, T0, T1, T2) T should be the system Timer. T0 is the time
 *          point where the squence is initiated T1 is the period of the
 *          sequence T2 < T1 is duration of the pulse.
 * 
 *          returns 1 if T0 + n*T1 <= T < T0 + n*T1 + T2 (n is an integer)
 *          returns 0 otherwise
 */
public class Pulses extends FunctionExpression {
    ...
    public String toString() {
        return "pulses(" + variables[0].toString() + ", "
