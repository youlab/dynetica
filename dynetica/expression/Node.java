...
public class Node  {
    ...
    public Node(Object o, Node p, Node l, Node r) { // constructor with parameters
	setElement(o);
	setParent(p);
	setLeft(l);
	setRight(r);
    ...
    public boolean isLeaf() { return isLeaf(this);}
	...
	if (isLeaf()) return element.toString();
	else
	    return (left.toString() + "  " + right.toString() + "  " + element.toString()); 
    }
} // Node
