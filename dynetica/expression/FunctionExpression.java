...
/** 
 * A FunctionExpression takes one or more GeneralExpressions as arguments. A derived class needs to define compute() properly.
 */
...
abstract public class FunctionExpression implements GeneralExpression{
    ...
    public GeneralExpression[] getVariables() { return variables; }
    public GeneralExpression getVariables(int index) { 
	return variables[index]; 
    }
    public int getLength(){ return variables.length;}
