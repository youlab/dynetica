...
public class ModularSystemManager extends javax.swing.JFrame {
        ...
        List openedSystems = new ArrayList(); //investigate this for tab problems
	...
	private void initComponents() {
		...
		twoParaScanItem
				.setToolTipText("Parametric sensitivity analysis on simultaneous changes on two parameters (or initial values of substances)");
		...
		mergeButton
				.setToolTipText("Merge a ReactiveSystem or ModularSystem with the current ModularSystem");
		...
		addAsModuleButton
				.setToolTipText("<html>Import a ReactiveSystem as a Module. <br/>Importing a Genetic System or ModularSystem as a Module may cause errors.</html>");
	...
	private void exitForm(java.awt.event.WindowEvent evt) {// GEN-FIRST:event_exitForm
            ...
            if (systemAvailable) {
                ...
                else if (confirm == JOptionPane.YES_OPTION && systemAvailable) {
                    saveSystem();
                    } 
            }
