...
public class FigureWindow extends javax.swing.JFrame {
    ...
    public JFrame frame1 = new javax.swing.JFrame();
    public JFrame frame2 = new javax.swing.JFrame();
    ...
    public void updateFigure() {
        ...
        for (int i = 0; i < indices.length; i++) {
            ...
            //
            // The reason is as follows: while this method is attempting to get
            // data
            // from system, the running simulation may have changed the system
            // in
            // the meantime. As a result, the length of s.getValues() may be
            // longer
            // than nPoints.
            //
    ...
    private void saveSelectedDataItemActionPerformed(
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            //
            dynetica.util.DyneticaProperties.setProperty("outputDirectory",
                    outDir);
    ...
    private void exitItemActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_exitItemActionPerformed
        System.out.println("Exit at exitItemActionPerformed");
        
        
        int confirm = JOptionPane.showOptionDialog(frame1,
                    "Exit This Application Without Saving?",
    ...
    private void closeItemActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_closeItemActionPerformed
        System.out.println("Exit at closeItemActionPerformed");
        
         int confirm1 = JOptionPane.showOptionDialog(frame2,
                    "Close This Application Without Saving?",
                    "Exit Confirmation", JOptionPane.YES_NO_OPTION,
                    JOptionPane.QUESTION_MESSAGE, null, null, null);
    ...
    private void exitForm(java.awt.event.WindowEvent evt) {// GEN-FIRST:event_exitForm
        ...
        this.dispose();
        System.out.println("Exit application at exitForm");
